...
%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{Dirac (Bose) statistics}
...
\question{Why $d^4x$ is Lorentz invariant}
\begin{equation*}
    \begin{aligned}
...
\question{Why the probability $\int d^3x \phi^*\phi$ is not conserved}
...
So square of \ref{eq:Dirac.0} should return to KG-equation (take $\hbar = c = 1$)
\begin{equation}
    \begin{aligned}
...
Another common representation (chiral representation):
\begin{equation}
...
\subsubsection{Photon Field (massless vector boson)}
\begin{equation}
    \Box^2 A_\mu(x) = 0
\end{equation}
the solution:
