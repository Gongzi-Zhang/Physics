...
\begin{table}[h]
    ...
    \begin{tabular}{c | l l}
	    ...
	    \hline
	    $\displaystyle \hbar=\frac{h}{2\pi}$	& $1\times 10^{-34} \ J\cdot s$  & $6.5821 \times 10^{-16} $ $eV \cdot s$	\\
	    \hline
	    $\hbar c$	&   & 200 (197) $MeV \cdot fm$	\\
	    \hline
	    $\epsilon_0$    & 
		$\begin{array}{l}
	    ...
	    \hline
	    Planck Mass/Energy $M_{PL} = \sqrt{\frac{\hbar c}{G}}$ & & $1.2 \times 10^{19}\ GeV\cdot c^{-2}$ \\
	    Planck length   $l_{PL} = \sqrt{\frac{\hbar G}{c^3}}$ & $1.6 \times 10^{-35}\ m$   &	\\
	    Planck time   $t_{PL} = \sqrt{\frac{\hbar G}{c^5}}$ & $5.4 \times 10^{-44}\ s$   &	\\
	    \hline
	    Fermi constant $G_F = \frac{\sqrt{2}g^2}{8M_W^2}$    & & $1.16 \times 10^{-5}\ GeV^{-2}$ \\
    \end{tabular}
\end{table}
...
\begin{table}[h]
	...
	\begin{tabular}{l|c}
	    ...
	    Bohr magneton   & $\displaystyle \mu_B=\frac{e\hbar}{2m_ec} = 5.8\times 10^{-11} \ MeV/T$ \\
